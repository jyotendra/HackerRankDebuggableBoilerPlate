...
const getResultsFileLocation = (testFileLoc) => {
    ...
    const resultFileLoc = join(__dirname, "results", testFileName);
...
const runTestCases = async () => {
    ...
    const spawnList = testCases.map(testFile => {
